  ...
  render() {
    return (
      <div>
        ...
        <>
        {this.props.uState.currentUser != undefined && <UserEditCardComponent TheUser={this.props.uState.currentUser} updateFunction={this.updateUser}></UserEditCardComponent>}
        </>
      </div>
    );
  }
